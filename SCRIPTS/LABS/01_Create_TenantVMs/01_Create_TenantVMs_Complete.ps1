...
# Tenant VM1
New-VM -Name TenantVM1 -ComputerName AzSHOST3 -VHDPath C:\ClusterStorage\S2D_vDISK1\TenantVM1\GUI.vhdx -MemoryStartupBytes 1GB `
-Generation 2 ` -Path C:\ClusterStorage\S2D_vDISK1\TenantVM1 | Out-Null

Set-VM -Name TenantVM1 -ComputerName AzSHOST3 -ProcessorCount 4 | Out-Null
...
Set-VMNetworkAdapter -VMName TenantVM1 -ComputerName AzSHOST3 -StaticMacAddress "00-11-22-33-44-55" | Out-Null
...
Get-VMNetworkAdapter -ComputerName AzSHOST3 -VMName TenantVM1 | Connect-VMNetworkAdapter -SwitchName sdnSwitch | Out-Null
...
"
# Start the VMs
Start-VM -Name TenantVM1 -ComputerName AzSHOST3
...
# Get the MACs
$TenantVM1Mac = (Get-VMNetworkAdapter -VMName TenantVM1 -ComputerName AzSHOST3).MacAddress
