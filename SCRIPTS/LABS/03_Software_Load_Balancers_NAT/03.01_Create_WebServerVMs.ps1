...
# WebServerVM1
New-VM -Name WebServerVM1 -ComputerName AzSHOST3 -VHDPath C:\ClusterStorage\S2D_vDISK1\WebServerVM1\GUI.vhdx -MemoryStartupBytes 1GB `
-Generation 2 -Path C:\ClusterStorage\S2D_vDISK1\WebServerVM1 | Out-Null

Set-VM -Name WebServerVM1 -ComputerName AzSHOST3 -ProcessorCount 4 | Out-Null
...
Set-VMNetworkAdapter -VMName WebServerVM1 -ComputerName AzSHOST3 -StaticMacAddress "00-11-22-33-44-60" | Out-Null
...
Get-VMNetworkAdapter -ComputerName AzSHOST3 -VMName WebServerVM1 | Connect-VMNetworkAdapter -SwitchName sdnSwitch | Out-Null
...
# Start the VMs
Start-VM -Name WebServerVM1 -ComputerName AzSHOST3
...
# Get the MACs
$WebServerVM1Mac = (Get-VMNetworkAdapter -VMName WebServerVM1 -ComputerName AzSHOST3).MacAddress
...
Invoke-Command -ComputerName AzSHOST3 -ArgumentList $nic -ScriptBlock {
