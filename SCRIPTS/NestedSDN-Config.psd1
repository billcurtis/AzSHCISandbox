@{
    ...
    coreVHDXPath                         = "C:\2019VHDS\Core.vhdx"                # This value controls the location of the Core VHDX.  
    ...
    NestedVMMemoryinGB                   = 20GB                                  # This value controls the amount of RAM for each Nested Hyper-V Host (SDNHOST1-3).
    SDNMGMTMemoryinGB                    = 25GB                                  # This value controls the amount of RAM for the SDNMGMT Nested VM which contains only the Console, Router, Admincenter, and DC VMs.
    ...
    # ProductKeys
    COREProductKey                       = "BCXP2-N2TRP-D88XX-FY9QH-CYWWF"        # Product Key for Windows Server 2016-2019 Core Datacenter Installation
    GUIProductKey                        = "BCXP2-N2TRP-D88XX-FY9QH-CYWWF"        # Product key for Windows Server 2016-2019 (Desktop Experience) Datacenter Installation
    Win10ProductKey                      = "QK7DT-NQ8JM-VYWDD-2QKD6-WXCKG"        # Product key for Windows 10 Installation
    ...
    natExternalVMSwitchName              = "vSwitch"                             # Name of external virtual switch on the physical host that has access to the Internet.
